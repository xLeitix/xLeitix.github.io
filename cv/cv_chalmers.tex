...
\PersonalEntry{Phone}{+46 733 056 914}
...
% \NewPart{Summary}{}
% I am currently Associate Professor (Docent) of Cloud-Based Software Engineering at Chalmers and University of Gothenburg, Sweden, where I lead the unit "Software Engineering 2" as well as the Internet Computing and Emerging Technologies (ICET) lab. I hold a PhD degree from Vienna University of Technology (in business informatics, focussing on cost-aware service composition). My primary research interest is empirical software engineering, with a particular focus on software performance and the development of Web- and cloud-based systems. My research is funded by Chalmers through the ICT Area of Advance, the Wallenberg AI, Autonomous Systems and Software Program (WASP), the Swedish Research Council (VR), and Sweden's Innovation Agency (VINNOVA). I have published over 100 peer-reviewed publications, leading to an h-index of 42 as tracked by Google Scholar.
...
\item{Unit manager of "Software Engineering 2" (5 faculty and $\sim$20 staff)}
\end{itemize}
}
\sepspace
...
I have successfully acquired grants (personal as well as project grants) totalling \textbf{around 2.5 million EUR}:
...
\begin{itemize}
  \item International Conference on Fundamentals of Software Engineering (FSE 2024)
  \item International Conference on Software Engineering (ICSE 2023)
  \item IEEE/ACM International Conference on Automated Software Engineering (ASE 2022 - 2023)
...
\item Journal of Systems and Software (JSS)
...
\item \textbf{J\"urgen Cito} (UZH, cloud performance engineering, co-supervised with Harald C. Gall, now Assistant Professor at TU Wien, Austria)
\end{itemize}
...
\begin{itemize}
\item \textbf{Diversity and inclusion in higher education} (2018, 2 ECTS)
\item \textbf{University teaching and learning}  (2017, 3 ECTS)
\item \textbf{Enhancing learning through writing} (2018, 5 ECTS)
\item \textbf{Perspectives on learning}  (2018, 2.5 ECTS)
\item \textbf{Supervision of research} (2017, 3 ECTS)
...
\begin{itemize}
  \item Distributed Systems Mini-Project (DIT356) (since 2023, $\approx$ 80 students)
  \item Architectures of Scale-Out Systems (DAT490) (since 2022, $\approx$ 40 students)
	\item Mobile and Web Development (DIT341) (2019 -- 2021, $\approx$ 100 students)
...
\begin{itemize}
  \item Advanced Internet Computing (fall 2008 - 2013, 140 students)
  \item Distributed Systems Technologies (spring 2009 - 2013, 140 students)
  \item Internet Computing Lab Work (spring 2009 - 2013)
  \item Verteilte Systeme (fall 2009 - fall 2010, $\approx$ 400 students)
  \item Grid Computing (spring 2008 - spring 2009, 10 students)
\end{itemize}

\subsection*{Thesis Supervision at Chalmers $|$ University of Gothenburg}

(partial list, total $\approx$ 20 supervised theses)
...
\begin{itemize}
  \item H. M. Ayas, \textbf{P. Leitner}, and R. Hebig: \emph{An Empirical Study of the Systemic and Technical Migration Towards Microservices}, Empirical Software Engineering (EMSE), 28, 4 (2023). https://doi.org/10.1007/s10664-023-10308-9  
  \item M. Grambow, D. Kovalev, C. Laaber, \textbf{P. Leitner}, and D. Bermbach: \emph{Using Microbenchmark Suites to Detect Application Performance Changes}, IEEE Transactions on Cloud Computing (TCC), 11(3), 2575-2590, 2023. https://doi.org/10.1109/TCC.2022.3217947  
  \begin{shaded}
  \item M. Jangali, Y. Tang, N. Alexandersson, \textbf{P. Leitner}, J. Yang, and W. Shang: \emph{Automated Generation and Evaluation of JMH Microbenchmark Suites from Unit Tests}, IEEE Transactions on Software Engineering (TSE), 49, 4 (2023), 1704–1725. https://doi.org/10.1109/TSE.2022.3188005  
  \end{shaded}
...
\begin{itemize}
	\item J. Scheuner, and \textbf{P. Leitner}:
...
\begin{itemize}
  \item  F. Markusse, \textbf{P. Leitner}, and  A. Serebrenik: \emph{Towards Continuous Performance Assessment of Java Applications With PerfBot}, Proceedings of the 4th International Workshop on Bots in Software Development (BotSE), invited contribution, 2023
